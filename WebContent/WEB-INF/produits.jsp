...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
		 <div class="container-fluid">
				    ...
				    <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
				      ...
				      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
				        <li class="nav-item">
				          <a class="nav-link " aria-current="page" href="/TP-Gestion-De-Commandes-MEHDI-BENREFAD/home">Home</a>
				        </li>
				        <li class="nav-item">
				          <a class="nav-link " href="/TP-Gestion-De-Commandes-MEHDI-BENREFAD/Controller">Commandes</a>
				        </li>
				        <li class="nav-item">
     ...
     <h1 style='margin-left:45%;'>Produits</h1>
		...
		<button style="margin-left:5%;" type="button" class="btn btn-success">Nouveau</button><br><br>
